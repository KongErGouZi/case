# Generated by Django 6.1 on 2026-09-11 20:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.SmallIntegerField(choices=[(0, '老师'), (1, '导师'), (2, '班主任')], default=0, verbose_name='角色')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_type', models.SmallIntegerField(choices=[(0, '付费'), (1, 'VIP专享')], default=0, verbose_name='付费类型')),
                ('brief', models.TextField(blank=True, max_length=2048, null=True, verbose_name='课程介绍')),
                ('level', models.SmallIntegerField(choices=[(0, '初级'), (1, '中级'), (2, '高级')], default=0, verbose_name='难度等级')),
                ('pub_date', models.DateField(auto_now_add=True, verbose_name='发布日期')),
                ('period', models.IntegerField(default=7, verbose_name='建议学习周期')),
                ...
                ('teacher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='course.teacher', verbose_name='授课老师')),
            ],
            options={
                'verbose_name': '课程',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_show', models.BooleanField(default=True, verbose_name='是否上架')),
                ('orders', models.IntegerField(verbose_name='优先级')),
                ('chapter', models.SmallIntegerField(default=1, verbose_name='章节ID')),
                ('name', models.CharField(max_length=32, verbose_name='章节名')),
                ('summary', models.TextField(max_length=1024, verbose_name='章节介绍')),
                ('pub_date', models.DateField(auto_now_add=True, verbose_name='发布时间')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursechapter', to='course.course', verbose_name='课程名称')),
            ],
            options={
                'verbose_name': '章节',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateField(auto_now_add=True, verbose_name='更新时间')),
